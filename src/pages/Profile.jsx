                                        ...
                                        <div className="member-card" key={`child-${child.childId}`}>
                                            ...
                                            {child.birthDate && (
                                                <div style={{marginTop: '8px', fontSize: '0.9rem', color: '#64748b'}}>
                                                    تاريخ
                                                    الميلاد: {new Date(child.birthDate).toLocaleDateString('ar-EG')}
                                                </div>
                                            )}
                                    ...
                                    <div className="property-card" key={property.propertyId}>
                                        ...
                                        <div className="property-details">
                                            <div className="property-detail">
                                                <span className="detail-label">عدد الوحدات:</span>
                                                <span
                                                    className="detail-value">{property.numberOfUnits || 'غير محدد'}</span>
                                            </div>
                                            <div className="property-detail">
                                                <span className="detail-label">المساحة:</span>
                                                <span
                                                    className="detail-value">{property.area ? `${property.area} م²` : 'غير محدد'}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            {documents.map((doc) => (
                                <div className="document-item" key={doc.id}>
                                    <div>
                                        ...
                                        <div style={{fontSize: '0.8rem', color: '#94a3b8'}}>تاريخ
                                            الإصدار: {doc.date}</div>
                                    </div>
